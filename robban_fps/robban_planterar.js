...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'robban_planterar.data';
      var REMOTE_PACKAGE_BASE = 'robban_planterar.data';
...
Module['FS_createPath']("/", "sounds", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_robban_planterar.data');

      };
      Module['addRunDependency']('datafile_robban_planterar.data');
    ...
    loadPackage({"files": [{"filename": "/asset/Image_1.png", "start": 0, "end": 1999100}, {"filename": "/asset/Image_2.png", "start": 1999100, "end": 4219820}, {"filename": "/asset/Image_3-Image_0.png", "start": 4219820, "end": 5501703}, {"filename": "/asset/Image_4.png", "start": 5501703, "end": 6566563}, {"filename": "/asset/bark.png", "start": 6566563, "end": 8565663}, {"filename": "/asset/bush.glb", "start": 8565663, "end": 9545383}, {"filename": "/asset/bush.png", "start": 9545383, "end": 9653589}, {"filename": "/asset/deer.glb", "start": 9653589, "end": 9915981}, {"filename": "/asset/ghost.glb", "start": 9915981, "end": 11956709}, {"filename": "/asset/leaf.png", "start": 11956709, "end": 12507402}, {"filename": "/asset/leaves.png", "start": 12507402, "end": 13572262}, {"filename": "/asset/nisse.mtl", "start": 13572262, "end": 13572709}, {"filename": "/asset/old_tree.glb", "start": 13572709, "end": 13664641}, {"filename": "/asset/old_tree2.glb", "start": 13664641, "end": 13760165}, {"filename": "/asset/pine.glb", "start": 13760165, "end": 13777765}, {"filename": "/asset/plant001a.mtl", "start": 13777765, "end": 13778292}, {"filename": "/asset/plant001a.obj", "start": 13778292, "end": 13818021}, {"filename": "/asset/rabbit.glb", "start": 13818021, "end": 13959413}, {"filename": "/asset/robban.glb", "start": 13959413, "end": 14044029}, {"filename": "/asset/some_tree (2).glb", "start": 14044029, "end": 14139549}, {"filename": "/asset/some_tree.glb", "start": 14139549, "end": 14235069}, {"filename": "/asset/tree.glb", "start": 14235069, "end": 21637249}, {"filename": "/asset/tree.mtl", "start": 21637249, "end": 21637758}, {"filename": "/asset/tree.mtl~", "start": 21637758, "end": 21638171}, {"filename": "/asset/tree.obj", "start": 21638171, "end": 23399714}, {"filename": "/asset/tree3.bin", "start": 23399714, "end": 24232386}, {"filename": "/asset/tree3.gltf", "start": 24232386, "end": 24236158}, {"filename": "/robban.png", "start": 24236158, "end": 25081438}, {"filename": "/sounds/axe-cut-1.wav", "start": 25081438, "end": 25253458, "audio": 1}, {"filename": "/sounds/shoot.wav", "start": 25253458, "end": 25562202, "audio": 1}], "remote_package_size": 25562202});
...
var wasmBinaryFile;
  wasmBinaryFile = 'robban_planterar.wasm';
...
// end include: preamble.js
  ...
  function _JS_BroadcastMessage(messagePtr) {
          var message = UTF8ToString(messagePtr);
          var messageObj = JSON.parse(message);
  
          // Only log important messages (not FULL_GAME_STATE or PLAYER_MOVE)
          if (messageObj.type !== 'FULL_GAME_STATE' && messageObj.type !== 'PLAYER_MOVE') {
  ...
  function _JS_GetRoomId(buffer, bufferSize) {
  ...
  function _JS_InitPeerNetwork() {
          ...
          // Check if we're joining a room - if so, don't create peer yet
          if (typeof window._joiningRoom !== 'undefined' && window._joiningRoom) {
              console.log('[PeerNetwork] Skipping peer creation - will create when joining room:', window._joiningRoom);
              return 1; // Return success but don't create peer yet
          }
          ...
          PeerNetworkState.peer.on('connection', function(conn) {
              ...
              conn.on('data', function(data) {
                  // Only log important messages (not FULL_GAME_STATE or PLAYER_MOVE)
                  if (data.type !== 'FULL_GAME_STATE' && data.type !== 'PLAYER_MOVE') {
  ...
  function JS_SetupConnection(conn) {
  ...
  function _JS_JoinRoom(roomIdPtr) {
          var roomId = UTF8ToString(roomIdPtr);
          console.log('[PeerNetwork] Connecting to:', roomId);
  
          // Create peer if it doesn't exist (for join scenario)
          if (!PeerNetworkState.peer) {
              console.log('[PeerNetwork] Creating peer for joining...');
              PeerNetworkState.peer = new Peer({
                  debug: 2,
                  config: {
                      iceServers: [
              ...
              PeerNetworkState.peer.on('open', function(id) {
                  console.log('[PeerNetwork] Peer ID for joining:', id);
                  // Now connect to the room
                  var conn = PeerNetworkState.peer.connect(roomId, {
                      reliable: true
                  });
                  // Setup connection handlers inline (same as JS_SetupConnection)
                  console.log('[PeerNetwork] Setting up connection handlers for:', conn.peer || 'new connection');
              ...
              return 1; // Return success, connection will happen when peer is ready
          }
          ...
          console.log('[PeerNetwork] Connection attempt initiated to:', roomId);
          JS_SetupConnection(conn);
  
          conn.on('close', function() {
              console.log('[PeerNetwork] Outgoing connection closed to:', roomId);
          });
  
          // Add timeout warning
          setTimeout(function() {
              if (!PeerNetworkState.connections[roomId]) {
                  console.warn('[PeerNetwork] Connection to', roomId, 'not established after 5 seconds');
                  console.warn('[PeerNetwork] This may indicate NAT traversal issues or the host is offline');
              }
          }, 5000);
  ...
  function _JS_SendMessageTo(peerIdPtr, messagePtr) {
...
PeerNetworkState = { peer: null, connections: {}, roomId: null, isHost: false };;
...
var wasmImports = {
  ...
  /** @export */
  JS_BroadcastMessage: _JS_BroadcastMessage,
  /** @export */
  JS_CreateRoom: _JS_CreateRoom,
  /** @export */
  JS_DisconnectPeer: _JS_DisconnectPeer,
  /** @export */
  JS_GetRoomId: _JS_GetRoomId,
  /** @export */
  JS_InitPeerNetwork: _JS_InitPeerNetwork,
  /** @export */
  JS_JoinRoom: _JS_JoinRoom,
  /** @export */
  JS_SendMessageTo: _JS_SendMessageTo,
  /** @export */
...
var _setUsername = Module['_setUsername'] = createExportWrapper('setUsername');
var _PrepareJoinRoom = Module['_PrepareJoinRoom'] = createExportWrapper('PrepareJoinRoom');
var _main = Module['_main'] = createExportWrapper('__main_argc_argv');
var _OnPeerReady = Module['_OnPeerReady'] = createExportWrapper('OnPeerReady');
var _OnPlayerJoined = Module['_OnPlayerJoined'] = createExportWrapper('OnPlayerJoined');
var _OnPlayerLeft = Module['_OnPlayerLeft'] = createExportWrapper('OnPlayerLeft');
var _OnNetworkMessage = Module['_OnNetworkMessage'] = createExportWrapper('OnNetworkMessage');
var _OnHostGameClicked = Module['_OnHostGameClicked'] = createExportWrapper('OnHostGameClicked');
var _OnJoinGameClicked = Module['_OnJoinGameClicked'] = createExportWrapper('OnJoinGameClicked');
var _OnDisconnectClicked = Module['_OnDisconnectClicked'] = createExportWrapper('OnDisconnectClicked');
...
var ___start_em_js = Module['___start_em_js'] = 94674;
var ___stop_em_js = Module['___stop_em_js'] = 94747;
